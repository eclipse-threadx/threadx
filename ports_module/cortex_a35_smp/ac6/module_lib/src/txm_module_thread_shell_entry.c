...
ALIGN_TYPE                      (*_txm_module_kernel_call_dispatcher)(ULONG type, ALIGN_TYPE param_1, ALIGN_TYPE param_2, ALIGN_TYPE param3);
...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _txm_module_thread_shell_entry                   Cortex-A35/AC6     */
/*                                                           6.1.3        */
/*  AUTHOR                                                                */
/*                                                                        */
