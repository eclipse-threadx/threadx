...
/* The module data is located here. This must match the RAM segment start address
   defined in the module's linker script.  */

#define MODULE_DATA_LOCATION (0x801A0000)
...
void module_manager_entry(ULONG thread_input)
{
    ...
    txm_module_manager_absolute_load_extended(&my_module, "my module", (void *) MODULE_CODE, (void *) MODULE_DATA_LOCATION);
