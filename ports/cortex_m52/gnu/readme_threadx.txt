...
The entry point in ThreadX for the Cortex-M52 using gnu tools uses the standard GNU
...
The Cortex-M52 vectors start at the label __tx_vectors or similar. The application may modify
