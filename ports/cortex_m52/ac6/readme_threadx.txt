...
FVP_MPS2_Cortex-M52_MDK simulator.
...
The entry point in ThreadX for the Cortex-M52 using AC6 tools uses the standard AC6
Cortex-M52 reset sequence. From the reset vector the C runtime will be initialized.
...
All suspended threads have the same stack frame in the Cortex-M52 version of
...
ThreadX provides complete and high-performance interrupt handling for Cortex-M52
...
The Cortex-M52 vectors start at the label __Vectors or similar. The application may modify
...
Note: the Cortex-M52 requires exception handlers to be thumb labels, this implies bit 0 set.
...
ThreadX for Cortex-M52 supports automatic ("lazy") VFP support, which means that applications threads
