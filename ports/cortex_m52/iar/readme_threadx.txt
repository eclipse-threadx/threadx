...
not simulate the Cortex-M52 correctly.


3.  System Initialization

The entry point in ThreadX for the Cortex-M52 using IAR tools is at label
...
The Cortex-M52 vectors start at the label __vector_table and is typically defined in a
