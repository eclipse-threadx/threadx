...
ThreadX management of FIQ interrupts is not provided because FIQ interrupts
cannot be disabled. The hardware does not support nested FIQ interrupts.
...
06/30/2020  Initial ThreadX version 6.0.1 for Cortex-R4 using IAR's ARM tools.
