...
#define TX_THREAD_EXTENSION_2                   int     Errno;             /* errno.  */
#define TX_THREAD_EXTENSION_3                   char *  strtok_saved_pos;  /* strtok() position.  */
...
CHAR                            _tx_version_id[] =
                                    "(c) 2024 Microsoft Corp. (c) 2026-present Eclipse ThreadX contributors.  *  ThreadX Cortex-R4/Green Hills Version 6.5.1.202602a *";
#else
