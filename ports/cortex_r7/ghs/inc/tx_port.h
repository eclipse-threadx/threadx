...
/* Define VFP extension for the Cortex-R7.  Each is assumed to be called in the context of the executing
   thread.  */
...
CHAR                            _tx_version_id[] =
                                    "(c) 2024 Microsoft Corp. (c) 2026-present Eclipse ThreadX contributors.  * ThreadX Cortex-R7/Green Hills Version 6.5.1.202602a *";
#else
