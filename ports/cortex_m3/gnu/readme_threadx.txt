...
2.  Demonstration System for Cortex-M3

The ThreadX demonstration is designed to execute on Cortex-M3 evaluation boards
...
The entry point in ThreadX for the Cortex-M3 using gnu tools uses the standard GNU 
