...
Windows-based Cortex-M3 simulator.
...
binary file that can be downloaded and executed on IAR's Cortex-M3 simulator.


3.  System Initialization

The entry point in ThreadX for the Cortex-M3 using IAR tools is at label 
