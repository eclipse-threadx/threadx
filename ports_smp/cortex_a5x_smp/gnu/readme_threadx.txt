...
The ThreadX SMP demonstration is designed to execute under the DS-5 debugger on the
'Debug Cortex-A53x4 SMP' FVP which must be downloaded from the ARM website and
requires a license.
...
setup for the Cortex-53x4 SMP FVP, so selecting "Debug" will launch the FVP, load
...
The entry point in ThreadX SMP for the Cortex-A5x using GCC tools is at label 
