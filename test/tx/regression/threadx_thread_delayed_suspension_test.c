...
time_t  start_wall;
    ...
    /* Wait until we see the delayed suspension set flag.
       ...
       not reached. How narrow it is depends on the build: this loop finishes in
       between a tenth of a second and three seconds in four of the five ThreadX
       configurations, and took 490 seconds in trace_build, where it was the most
