...
# comparable with this one. Measured over the six configurations: 4338/4339 lines
# and 4560/4627 branches.
min_line=${TX_COVERAGE_MIN_LINE:-99.90}
min_branch=${TX_COVERAGE_MIN_BRANCH:-98.40}
